<?php
App::uses('FacebookUsersFacebookVideosController', 'Controller');

/**
 * FacebookUsersFacebookVideosController Test Case
 *
 */
class FacebookUsersFacebookVideosControllerTest extends ControllerTestCase {
