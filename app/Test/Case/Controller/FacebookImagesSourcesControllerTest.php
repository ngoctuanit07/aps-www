<?php
App::uses('FacebookImagesSourcesController', 'Controller');

/**
 * FacebookImagesSourcesController Test Case
 *
 */
class FacebookImagesSourcesControllerTest extends ControllerTestCase {
