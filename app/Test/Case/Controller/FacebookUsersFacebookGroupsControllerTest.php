<?php
App::uses('FacebookUsersFacebookGroupsController', 'Controller');

/**
 * FacebookUsersFacebookGroupsController Test Case
 *
 */
class FacebookUsersFacebookGroupsControllerTest extends ControllerTestCase {
