<?php
App::uses('FacebookMessagesTagsController', 'Controller');

/**
 * FacebookMessagesTagsController Test Case
 *
 */
class FacebookMessagesTagsControllerTest extends ControllerTestCase {
