<?php
App::uses('FacebookGroupFeedsController', 'Controller');

/**
 * FacebookGroupFeedsController Test Case
 *
 */
class FacebookGroupFeedsControllerTest extends ControllerTestCase {
