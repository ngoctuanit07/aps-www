<?php
App::uses('FacebookUsersFacebookEventsController', 'Controller');

/**
 * FacebookUsersFacebookEventsController Test Case
 *
 */
class FacebookUsersFacebookEventsControllerTest extends ControllerTestCase {
