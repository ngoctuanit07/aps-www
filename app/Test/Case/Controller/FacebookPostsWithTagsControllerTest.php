<?php
App::uses('FacebookPostsWithTagsController', 'Controller');

/**
 * FacebookPostsWithTagsController Test Case
 *
 */
class FacebookPostsWithTagsControllerTest extends ControllerTestCase {
