<?php
App::uses('FacebookActivitiesController', 'Controller');

/**
 * FacebookActivitiesController Test Case
 *
 */
class FacebookActivitiesControllerTest extends ControllerTestCase {
