<?php
App::uses('FacebookConcentrationsController', 'Controller');

/**
 * FacebookConcentrationsController Test Case
 *
 */
class FacebookConcentrationsControllerTest extends ControllerTestCase {
