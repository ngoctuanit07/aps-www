<?php
App::uses('FacebookPostsPropertiesController', 'Controller');

/**
 * FacebookPostsPropertiesController Test Case
 *
 */
class FacebookPostsPropertiesControllerTest extends ControllerTestCase {
