<?php
App::uses('FacebookFriendlistsController', 'Controller');

/**
 * FacebookFriendlistsController Test Case
 *
 */
class FacebookFriendlistsControllerTest extends ControllerTestCase {
