<?php
App::uses('FacebookTelevisionsController', 'Controller');

/**
 * FacebookTelevisionsController Test Case
 *
 */
class FacebookTelevisionsControllerTest extends ControllerTestCase {
