<?php
App::uses('FacebookPostsPrivaciesController', 'Controller');

/**
 * FacebookPostsPrivaciesController Test Case
 *
 */
class FacebookPostsPrivaciesControllerTest extends ControllerTestCase {
