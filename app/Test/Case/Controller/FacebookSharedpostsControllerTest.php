<?php
App::uses('FacebookSharedpostsController', 'Controller');

/**
 * FacebookSharedpostsController Test Case
 *
 */
class FacebookSharedpostsControllerTest extends ControllerTestCase {
