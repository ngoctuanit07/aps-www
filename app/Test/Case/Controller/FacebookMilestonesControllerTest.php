<?php
App::uses('FacebookMilestonesController', 'Controller');

/**
 * FacebookMilestonesController Test Case
 *
 */
class FacebookMilestonesControllerTest extends ControllerTestCase {
