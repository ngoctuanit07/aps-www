<?php
App::uses('FacebookEducationsController', 'Controller');

/**
 * FacebookEducationsController Test Case
 *
 */
class FacebookEducationsControllerTest extends ControllerTestCase {
