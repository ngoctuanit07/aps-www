<?php
App::uses('FacebookUsersFacebookAlbumsController', 'Controller');

/**
 * FacebookUsersFacebookAlbumsController Test Case
 *
 */
class FacebookUsersFacebookAlbumsControllerTest extends ControllerTestCase {
