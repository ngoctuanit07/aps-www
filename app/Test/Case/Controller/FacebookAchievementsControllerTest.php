<?php
App::uses('FacebookAchievementsController', 'Controller');

/**
 * FacebookAchievementsController Test Case
 *
 */
class FacebookAchievementsControllerTest extends ControllerTestCase {
