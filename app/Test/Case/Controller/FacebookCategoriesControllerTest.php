<?php
App::uses('FacebookCategoriesController', 'Controller');

/**
 * FacebookCategoriesController Test Case
 *
 */
class FacebookCategoriesControllerTest extends ControllerTestCase {
