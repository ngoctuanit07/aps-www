<?php
App::uses('FacebookEventFeedsController', 'Controller');

/**
 * FacebookEventFeedsController Test Case
 *
 */
class FacebookEventFeedsControllerTest extends ControllerTestCase {
