<?php
App::uses('FacebookPhotosFacebookMilestonesController', 'Controller');

/**
 * FacebookPhotosFacebookMilestonesController Test Case
 *
 */
class FacebookPhotosFacebookMilestonesControllerTest extends ControllerTestCase {
